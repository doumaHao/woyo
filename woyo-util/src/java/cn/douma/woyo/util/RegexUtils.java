...
public class RegexUtils {  
     ...
     * @return 验证成功返回true，验证失败返回false 
     */   
    public static boolean checkMobile(String mobile,Boolean isDetail) {
    	String regex=(isDetail==Boolean.TRUE)?"(\\+\\d+)?1[3458]\\d{9}$":"^\\d{11}+$";  
     ...
     * @return
     */
    public static int idNumberToAge(String idNumber){
